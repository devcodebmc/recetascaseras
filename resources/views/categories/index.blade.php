<x-app-layout>
    ...
    @if (session('success'))
    <div id="flash-message" class="fixed top-20 right-4 flex items-center justify-between p-2 text-sm rounded-lg shadow-md bg-white border border-gray-200">
    ...
    <script>
        ...
        }, 4000); // Ocultar después de 3 segundos
    </script>
    @endif
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <button class="text-sm font-medium text-gray-500 hover:text-gray-700" title="Editar">
                                        ...
                                        <form action="{{ route('categories.destroy', $category->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-sm font-medium text-gray-500 hover:text-gray-700 ml-2" title="Eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoría?');">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
